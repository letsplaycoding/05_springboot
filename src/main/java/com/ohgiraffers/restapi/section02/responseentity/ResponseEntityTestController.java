...
public class ResponseEntityTestController {
    ...
    public ResponseEntityTestController() {
        ...
        users.add(new UserDTO(1,"user01","pass01","한동숙",new java.util.Date()));
        users.add(new UserDTO(2,"user02","pass02","동수칸",new java.util.Date()));
        users.add(new UserDTO(3,"user03","pass03","롱수칸",new java.util.Date()));
    ...
    /* 설명. 2. 빌더를 활용한 메소드 체이닝 방식으로 ResponseEntity 객체 만들기(요즘 유행하는 방식) */
